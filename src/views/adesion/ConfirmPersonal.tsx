...
const ConfirmAdesionPersonal: React.FC = () => {
	...
	return (
		<main className="relative max-sm:h-screen">
			<img src={fundoBlue2} alt="" className="object-cover w-full h-full" />
			<div className="absolute top-0 left-0 w-full h-full flex flex-col items-center max-sm:overflow-y-auto">
				...
				<section className=" max-sm:text-sm flex flex-col z-50 w-2/3 gap-4 my-12 rounded-md justify-between items-center p-10 bg-[#000760] max-sm:gap-2 max-sm:w-full max-sm:h-auto max-sm:m-0 shadow-lg shadow-black">
					...
					<form className="w-[90%] max-sm:w-[95%] grid grid-cols-2 grid-rows-2 max-sm:flex max-sm:flex-col gap-4">
						<div className="flex flex-col gap-3 items-center">
							...
							<p className="bg-transparent bg-[#171818] h-[50px]  text-[14px] w-full shadow-inner shadow-black rounded-md flex justify-center items-center px-4 font-bold text-white">
								{personalData?.nome || ""}
							</p>
						</div>
						...
						<div className="flex flex-col gap-3 items-center col-span-2">
							...
							<ul className="bg-transparent bg-[#171818]  text-[14px] w-full shadow-inner shadow-black rounded-md p-4 list-disc h-12 overflow-y-auto text-white">
