...
const TicketsPricesEnterprise: React.FC = () => {
  ...
  const saveToLocalStorage = (
    ...
    updatedData.totalQuantity =
      (updatedData.totalQuantity || 0) + totalQuantity;
  ...
  return (
    <main className="max-sm:h-full relative h-screen bg-[#001032] flex flex-col items-center max-sm:overflow-y-auto">
