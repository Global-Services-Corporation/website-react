...
const PersonalForm: React.FC = () => {
	...
	return (
		<section className="w-screen flex flex-row">
			...
			<div className="flex flex-col w-[40rem]">
				...
				<div className="flex flex-col gap-10 py-10 px-28">
					<div className="flex flex-col">
						<h1 className="font-semibold text-[30px] text-[#FF9800]">Formulário de Adesão</h1>
						<p className="text-[#000000] text-[16px]">Preparado para o evento?</p>
					</div>
				<form
				...
				>
					...
					<label htmlFor="nome" className="font-semibold text-[15px] text-[#000000]">
						Nome
					</label>
					<Controller
						name="nome"
					...
					<div className="flex flex-col gap-3">
					<label htmlFor="email" className="font-semibold text-[15px] text-[#000000]">
						Email
					</label>
					<Controller
						name="email"
					...
					<div className="flex flex-col gap-3">
					<label htmlFor="contacto" className="font-semibold text-[15px] text-[#000000]">
						Contacto Telefónico
					</label>
					<Controller
						name="contacto"
			...
			<div className="flex flex-col bg-yellow-700 w-[40rem] h-full items-center">
