...
const Newsletter: React.FC = () => {
  return (
    <section className="w-4/5 max-sm:w-4/5 h-80 flex text-white bg-[#00C7FFe8] rounded-2xl items-center justify-between px-16 max-sm:px-5 mt-32 max-sm:mt-0 relative">
