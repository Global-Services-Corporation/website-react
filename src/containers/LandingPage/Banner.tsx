...
const Banner: React.FC = () => {
  return (
    <section className="w-4/5 h-[554px] flex gap-32 max-sm:h-96 justify-between">
      <div className="w-[427px] max-sm:text-center max-sm:items-center h-[395] flex flex-col gap-8">
        <h1 className="w-full h-[249] leading-none text-4xl max-sm:z-50 font-bold">
          Dar poder às <span className="text-[#30CBE8]">suas escolhas</span> de{" "}
          <span className="text-[#30CBE8]">seguros</span>
        </h1>
        <p className="text-[#C5C5C5] max-sm:text-base text-[20px] font-bold">
      ...
      <div className="w-[772px] h-[554px] relative max-sm:hidden">
        <img src={mundo} alt="" className=" absolute -top-10 "/>
