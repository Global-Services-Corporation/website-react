import { seguro, academia, saude, mundo, mundoWeb } from "../../assets"
	...
	return (
		<section className="w-4/5 max-sm:w-full h-[554px] flex gap-32 max-sm:h-96 justify-between max-sm:relative">
			<div className="w-[427px] max-sm:w-full max-sm:text-center max-sm:items-center h-[395px] max-sm:h-72 flex flex-col gap-8 max-sm:absolute max-sm:z-40 ">
				<h1 className="w-full leading-none text-[59px] max-sm:text-[35px] max-sm:z-40 font-bold">
			...
			<div className="w-[772px] max-sm:w-full h-[554px] max-sm:h-[600px] relative max-sm:absolute max-sm:-top-16">
				<img src={mundoWeb} alt="" className="max-sm:hidden w-full" />
				<img
					src={mundo}
					alt=""
					className="absolute max-sm:object-cover  max-sm:top-0 max-sm:h-full max-sm:z-0 w-full hidden max-sm:block"
				/>
				<img
					src={seguro}
					alt=""
					className="absolute top-0 start-10 max-sm:hidden"
				/>
				<img
					src={academia}
					alt=""
				...
				<img
					src={saude}
					alt=""
					className="absolute start-[340px] top-28 max-sm:hidden w-52"
				/>
			</div>
		</section>
	)
