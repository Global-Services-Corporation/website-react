import { aboutEvent, agenda, participar, expor, patrocinar, speaker } from "../../assets"
		...
		<section className="w-full h-[1049px] gap-20 flex items-center justify-center flex-col">
			...
			{cardInfo.map((info, index)=> (
				...
				key={index}>
					...
					<p className="font-semibold text-xl text-[#1355E9]">{info.title}</p>
					</div>
				</div>
			))}
			</div>
			...
			<div className="flex gap-14 h-[530px]">
				...
				<div className="gap-5 flex flex-col">
					...
					<p className="h-64 w-[534px] text-justify">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Explicabo maxime consequatur reprehenderit tempore ratione, omnis unde quisquam iusto nemo nesciunt dolores rem! Numquam culpa quo quas. Necessitatibus quo nostrum laudantium.
...
omnis unde quisquam iusto nemo nesciunt dolores rem! Numquam culpa quo quas. Necessitatibus quo nostrum laudantium.</p>
				<a href="" className="w-56 h-9 bg-[#1355E9] rounded-md text-white font-bold text-sm flex items-center justify-center">Participe do evento</a>
